...
Wraps the RedTrack /offers and /networks REST API endpoints.
"""
...
def export_offers(api_key: str, base_url: str,
    ...
    Args:
        api_key: RedTrack API key.
        base_url: API base URL.
        ids: Comma-separated offer IDs to export.
        title: Filter by title.
        networks: Filter by network IDs.
        countries: Filter by country codes.
        status: Filter by status.
        tags: Filter by tags.

    Returns:
        API response with export info (S3 URL or job ID).
    """
    params: dict = {}
    if ids:
        params["ids"] = ids
...
def list_offer_sources(api_key: str, base_url: str) -> dict:
    ...
    """
    return api_get("/networks", api_key=api_key, base_url=base_url)
...
def get_offer_source(api_key: str, base_url: str, source_id: str) -> dict:
    ...
    """
    return api_get(f"/networks/{source_id}", api_key=api_key, base_url=base_url)
...
def create_offer_source(api_key: str, base_url: str, name: str,
    ...
    return api_post("/networks", data=data, api_key=api_key, base_url=base_url)
...
def delete_offer_source(api_key: str, base_url: str, source_id: str) -> dict:
    ...
    Returns:
        Status dict.
    """
    return api_delete(f"/networks/{source_id}", api_key=api_key, base_url=base_url)
